...
| ----------------------- | ------------ | ------------ | ----------------- | ------------------- | -------------------- | ---------------------------------- | --------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| CiviCRM                 | ✅           | 🟡           | 🟡                | ✅                  | ✅                   | ✅                                 | ✅                          | ❌                            | Strongest ownership model; commonly CMS-attached, but not dependent on vendor-hosted site builder.                        |
| Pipedrive               | 🟡           | 🟡           | 🟡                | 🟡                  | 🟡                   | 🟡                                 | 🟡                          | ❌                            | Public-facing donation / event / membership forms usually come from adjacent tools rather than Pipedrive itself.          |
| Zeffy                   | ✅           | ✅           | ✅                | ❌                  | ❌                   | ❌                                 | ✅                          | ❌                            | Hosted fundraising pages and embeddable widgets are the default path; custom frontend ownership is limited.               |
| DonorView               | ✅           | ✅           | ✅                | ❌                  | 🟡                   | 🟡                                 | ✅                          | ❌                            | Practical hosted and embedded forms; deeper custom behavior typically needs integration work.                             |
| Givebutter              | ✅           | ✅           | ✅                | ❌                  | 🟡                   | 🟡                                 | ✅                          | ❌                            | Gives Temple quick hosted pages and embed tools without requiring a separate site builder.                                |
| Bloomerang              | ✅           | ✅           | 🟡                | ❌                  | 🟡                   | 🟡                                 | ✅                          | ❌                            | Common path is hosted or embedded fundraising forms/pages, not fully custom frontend control.                             |
| Givebutter + Bloomerang | ✅           | ✅           | ✅                | ❌                  | 🟡                   | 🟡                                 | ✅                          | ❌                            | In practice Temple would usually use Givebutter for public forms and Bloomerang for CRM/fundraising operations.           |
| Neon CRM                | ✅           | ✅           | ✅                | ❌                  | 🟡                   | 🟡                                 | ✅                          | ❌                            | Stronger all-in-one public form coverage than most SaaS CRMs; custom paths exist but are still more bounded than CiviCRM. |
