...
| Fund allocation tracking (annual, monthly, endowment, critical solicitations) ✅ | ✅             | 🛠️             | 🛠️             | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | 🛠️             |
| Revenue categories (by program/fund/campaign) ✅ [\[\*\]](#note-11)              | ✅             | 🟡             | 🛠️             | ✅             | 🟡             | 🟡             | 🟡                      | ✅             |
| Grant tracking 🟡                                                                | ✅             | 🟡             | ❌             | 🟡             | ❌             | ❌             | ❌                      | 🟡             |
| Donor tiers ❓                                                                   | 🟡             | ✅             | 🟡             | ✅             | 🟡             | ✅             | ✅                      | ✅             |
| Donor lifetime value calculation ✅                                              | 🟡             | 🟡             | 🛠️             | ✅             | ✅             | ✅             | ✅                      | ✅             |
| Donor segmentation ✅                                                            | ✅             | ✅             | 🟡             | ✅             | ✅             | ✅             | ✅                      | ✅             |
...
| Revenue reporting ✅                                                             | ✅             | ✅             | ✅             | ✅             | ✅             | ✅             | ✅                      | ✅             |
| Campaign ROI tracking ❓                                                         | 🛠️             | 🟡             | [8](#note-8)   | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | 🛠️             |
| Stripe integration 🟡                                                            | ✅             | ✅             | ❌             | ✅             | ✅             | 🟡             | ✅                      | 🟡             |
| PayPal integration 🟡                                                            | ✅             | 🟡             | ❌             | ✅             | 🟡             | 🟡             | 🟡                      | 🟡             |
| QuickBooks integration ✅                                                        | 🛠️             | ✅             | [7](#note-7)   | ✅             | 🟡             | 🟡             | 🟡                      | 🟡             |
| Accounting linkage (sync to accounting system) ✅                                | 🛠️             | ✅             | [7](#note-7)   | ✅             | 🟡             | 🟡             | 🟡                      | 🟡             |
...
| API/webhook depth for custom site workflows ✅                                   | ✅             | ✅             | 🛠️             | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | ✅             |
| Non-widget implementation path (API-first/headless) ✅                           | ✅             | 🛠️             | ❌             | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | 🛠️             |
| CMS/plugin ecosystem support 🟡                                                  | ✅             | 🟡             | 🛠️             | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | 🛠️             |
...
| Workflow automation depth (multi-step, branching) 🟡 [\[\*\]](#note-11)          | 🟡             | ✅             | ❌             | 🛠️             | 🛠️             | 🛠️             | 🛠️                      | 🛠️             |
...
| API rate limits and integration reliability at scale 🟡 [\[\*\]](#note-11)       | ✅             | 🟡             | ❌             | 🛠️             | 🛠️             | 🟡             | 🛠️                      | 🟡             |
...
| Score (✅=3, 🟡=2, 🛠️=1, 🟠=1, [#]=1, ❓=0, ❌=0)                                | 234            | 206            | 137            | 211            | 195            | 186            | 204                     | 225            |
| Priority-weighted score (Priority: ✅=x3, 🟡=x2, ❓=x1)                          | 597            | 525            | 358            | 543            | 502            | 475            | 523                     | 578            |
...
| Pipedrive               | Public list price (billed annually, per seat): Lite $14, Growth $39, Premium $59, Ultimate $79; add-ons extra. [Pricing](https://www.pipedrive.com/en/pricing)                                                                                                                                                     |
| Zeffy                   | Platform is generally no-subscription for core use; payment processing and optional integrations may add costs.                                                                                                                                                                                                    |
| DonorView               | Smallest published tier (up to 1,000 constituents) shows $183/mo regular or $128/mo at 12-month commitment; deeper discounts require longer prepaid terms. [Pricing](https://www.donorview.com/pricing)                                                                                                            |
| Givebutter              | Givebutter Plus smallest published contact tier (<=250 contacts) is $29/mo (or $348 billed annually for 12 months); core platform remains free with processor/tip model considerations. [Pricing](https://givebutter.com/pricing)                                                                                  |
| Bloomerang              | Tiered nonprofit pricing; confirm current quote for records/users/modules required. [Pricing](https://bloomerang.com/pricing/)                                                                                                                                                                                     |
| Givebutter + Bloomerang | Combined estimate under this rule is Givebutter Plus ($29/mo at <=250 contacts, 12-month context) + Bloomerang base subscription (quote-dependent from pricing page), plus processor/integration costs. [Givebutter Pricing](https://givebutter.com/pricing) [Bloomerang Pricing](https://bloomerang.com/pricing/) |
| Neon CRM                | Published starting prices: Essentials $99/mo, Impact $209/mo, Empower $409/mo; one-time implementation starts at $349. [Pricing](https://neonone.com/solutions/neon-crm-overview/neon-crm-pricing/)                                                                                                                |
...
<a id="note-11"></a>
Rows marked with `[*]` were added later; priorities are now assigned, but the marker is kept to indicate newly added criteria.
