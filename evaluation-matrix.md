...
| Criteria                                                                         | CiviCRM      | Pipedrive    | Zeffy | DonorView | Givebutter | Bloomerang | Neon CRM |
| -------------------------------------------------------------------------------- | ------------ | ------------ | ----- | --------- | ---------- | ---------- | -------- |
| Contact records ✅                                                               | ✅           | ✅           |       |           |            |            |          |
| Custom fields ✅                                                                 | ✅           | ✅           |       |           |            |            |          |
| Tagging ✅                                                                       | ✅           | ✅           |       |           |            |            |          |
...
| Waitlist management 🟡                                                           | 🟡           | [5](#note-5) |       |           |            |            |          |
| Event capacity limits ✅                                                         | ✅           | [5](#note-5) |       |           |            |            |          |
...
| Cashapp/Venmo ✅                                                                 | [6](#note-6) | [6](#note-6) |       |           |            |            |          |
